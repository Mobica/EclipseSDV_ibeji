...
pub struct VehicleData {
    pub speed: watch::Receiver<sdv::vehicle_v3::vehicle_speed::TYPE>,
    pub mileage: watch::Receiver<sdv::vehicle_v3::vehicle_mileage::TYPE>,
    pub gear: watch::Receiver<sdv::vehicle_v3::vehicle_gear::TYPE>,
    pub fuel: watch::Receiver<sdv::vehicle_v3::vehicle_fuel::TYPE>,
    pub rpm: watch::Receiver<sdv::vehicle_v3::vehicle_rpm::TYPE>,
    pub wp_fl: watch::Receiver<sdv::vehicle_v3::vehicle_wheel_pressure_fl::TYPE>,
    pub wp_fr: watch::Receiver<sdv::vehicle_v3::vehicle_wheel_pressure_fr::TYPE>,
    pub wp_rl: watch::Receiver<sdv::vehicle_v3::vehicle_wheel_pressure_rl::TYPE>,
    pub wp_rr: watch::Receiver<sdv::vehicle_v3::vehicle_wheel_pressure_rr::TYPE>,
}

#[derive(Debug, Serialize, Deserialize)]
struct Property {
    #[serde(rename = "VehicleSpeed")]
    vehicle_speed: sdv::vehicle_v3::vehicle_speed::TYPE,
    #[serde(rename = "$metadata")]
    speed_metadata: Metadata,
    #[serde(rename = "VehicleMileage")]
    vehicle_mileage: sdv::vehicle_v3::vehicle_mileage::TYPE,
    #[serde(rename = "$metadata")]
    mileage_metadata: Metadata,
    #[serde(rename = "VehicleGear")]
    vehicle_gear: sdv::vehicle_v3::vehicle_gear::TYPE,
    #[serde(rename = "$metadata")]
    gear_metadata: Metadata,
    #[serde(rename = "VehicleFuel")]
    vehicle_fuel: sdv::vehicle_v3::vehicle_fuel::TYPE,
    #[serde(rename = "$metadata")]
    fuel_metadata: Metadata,
    #[serde(rename = "VehicleRpm")]
    vehicle_rpm: sdv::vehicle_v3::vehicle_rpm::TYPE,
    #[serde(rename = "$metadata")]
    rpm_metadata: Metadata,

    #[serde(rename = "VehicleWheelPressureFL")]
    vehicle_wheel_pressure_fl: sdv::vehicle_v3::vehicle_wheel_pressure_fl::TYPE,
    #[serde(rename = "$metadata")]
    wp_fl_metadata: Metadata,

    #[serde(rename = "VehicleWheelPressureFR")]
    vehicle_wheel_pressure_fr: sdv::vehicle_v3::vehicle_wheel_pressure_fr::TYPE,
    #[serde(rename = "$metadata")]
    wp_fr_metadata: Metadata,

    #[serde(rename = "VehicleWheelPressureRL")]
    vehicle_wheel_pressure_rl: sdv::vehicle_v3::vehicle_wheel_pressure_rl::TYPE,
    #[serde(rename = "$metadata")]
    wp_rl_metadata: Metadata,

    #[serde(rename = "VehicleWheelPressureRR")]
    vehicle_wheel_pressure_rr: sdv::vehicle_v3::vehicle_wheel_pressure_rr::TYPE,
    #[serde(rename = "$metadata")]
...
fn create_property_json(data: &VehicleData) -> String {
    let speed_metadata = Metadata { model: sdv::vehicle_v3::vehicle_speed::ID.to_string() };
    let mileage_metadata = Metadata { model: sdv::vehicle_v3::vehicle_mileage::ID.to_string() };
    let gear_metadata = Metadata { model: sdv::vehicle_v3::vehicle_gear::ID.to_string() };
    let fuel_metadata = Metadata { model: sdv::vehicle_v3::vehicle_fuel::ID.to_string() };
    let rpm_metadata = Metadata { model: sdv::vehicle_v3::vehicle_rpm::ID.to_string() };
    let wp_fl_metadata = Metadata { model: sdv::vehicle_v3::vehicle_wheel_pressure_fl::ID.to_string() };
    let wp_fr_metadata = Metadata { model: sdv::vehicle_v3::vehicle_wheel_pressure_fr::ID.to_string() };
    let wp_rl_metadata = Metadata { model: sdv::vehicle_v3::vehicle_wheel_pressure_rl::ID.to_string() };
    let wp_rr_metadata = Metadata { model: sdv::vehicle_v3::vehicle_wheel_pressure_rr::ID.to_string() };
...
impl ProviderImpl {
    ...
    pub fn new(data_stream: VehicleData, min_interval_ms: u64) -> Self {
        ...
        entity_map.insert(sdv::vehicle_v3::vehicle_speed::ID.to_string(), Vec::new());
        entity_map.insert(sdv::vehicle_v3::vehicle_mileage::ID.to_string(), Vec::new());
        entity_map.insert(sdv::vehicle_v3::vehicle_gear::ID.to_string(), Vec::new());
        entity_map.insert(sdv::vehicle_v3::vehicle_fuel::ID.to_string(), Vec::new());
        entity_map.insert(sdv::vehicle_v3::vehicle_rpm::ID.to_string(), Vec::new());
        entity_map.insert(sdv::vehicle_v3::vehicle_wheel_pressure_fl::ID.to_string(), Vec::new());
        entity_map.insert(sdv::vehicle_v3::vehicle_wheel_pressure_fr::ID.to_string(), Vec::new());
        entity_map.insert(sdv::vehicle_v3::vehicle_wheel_pressure_rl::ID.to_string(), Vec::new());
        entity_map.insert(sdv::vehicle_v3::vehicle_wheel_pressure_rr::ID.to_string(), Vec::new());
        ...
        tokio::spawn(async move {
            ...
            loop {
                ...
                info!(
                    ...
                    sdv::vehicle_v3::vehicle_speed::NAME,
                    sdv::vehicle_v3::vehicle_mileage::NAME,
                    sdv::vehicle_v3::vehicle_gear::NAME,
                    sdv::vehicle_v3::vehicle_fuel::NAME,
                    sdv::vehicle_v3::vehicle_rpm::NAME,
                    sdv::vehicle_v3::vehicle_wheel_pressure_fl::NAME,
                    sdv::vehicle_v3::vehicle_wheel_pressure_fr::NAME,
                    sdv::vehicle_v3::vehicle_wheel_pressure_rl::NAME,
                    sdv::vehicle_v3::vehicle_wheel_pressure_rr::NAME,
                );
