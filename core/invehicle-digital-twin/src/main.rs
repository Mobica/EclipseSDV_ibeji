...
const INVEHICLE_DIGITAL_TWIN_SERVICE_NAMESPACE: &str = "sdv.pubsub";
const INVEHICLE_DIGITAL_TWIN_SERVICE_NAME: &str = "dynamic.pubsub";
const INVEHICLE_DIGITAL_TWIN_SERVICE_VERSION: &str = "0.1.0";
